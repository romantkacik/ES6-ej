...
const filterAge2 = ages2.filter((age) => age % 2 === 0)
...
const newArrayStreamers = streamers.filter(
...
const streamersU = streamers2.filter((streamerU) =>
...
const newStremers = streamers3.filter((streamer) => {
